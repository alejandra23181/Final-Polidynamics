...
<body>
  ...
  <ul id="Secciones">
    <li ><a href="/PoliDynamics/views/docente/Index.php"> Inicio</a></li>
      ...
      <li class="active"><a href="\PoliDynamics\views\docente\vistas\prestamo\ListarPrestamos.php"> Gestión de préstamos</a></li>
  ...
  <form  action = "metodos/MetodoEditar.php">
        ...
        <div class="form-group">
            <div class="row">
                    ...
                    <input type="time" name="hora_inicio" class="form-control" value="<?php echo $Filas['HORA_INICIO'] ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                    <label>Hora fin*:</label><br>   
                    <input type="time" name="hora_fin" class="form-control" value="<?php echo $Filas['HORA_FIN'] ?>" required>
                    </div>
